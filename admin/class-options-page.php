...
class Options_Page {
	 ...
	 * @param array $options Options.
	 */
	private function render_support_tab( $options ) {
		?>
		<p><strong>This plugin is an open source project and I would love you to help me make it better.</strong></p>

		<p><a href="https://wordpress.org/support/plugin/remove-noreferrer/" target="_blank" rel="noreferrer nofollow" class="button button-primary"><?php echo __( 'Rate the plugin!', 'remove-noreferrer' ); ?> 😍</a></p>
