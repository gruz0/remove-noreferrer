...
docker-compose $COMPOSER_ARGS exec $TTY wordpress wp option update remove_noreferrer '{"where_should_the_plugin_work":["text_widget"]}' --format=json --allow-root > /dev/null
